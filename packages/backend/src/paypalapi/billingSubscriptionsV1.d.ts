...
export interface components {
  schemas: {
    ...
    subscription_billing_info: {
      ...
      readonly cycle_executions?: components['schemas']['cycle_execution'][]
    ...
    capture_status: {
       ...
       * @enum {string}
       */
      readonly status?: 'COMPLETED' | 'DECLINED' | 'PARTIALLY_REFUNDED' | 'PENDING' | 'REFUNDED'
      /** @description The details of the captured payment status. */
     ...
     */
    transaction: components['schemas']['capture_status'] & {

...
export type ProjectMemberListProjectFragment = { __typename?: 'Project', canModify: boolean, id: string, title: string, inviteKey: string, members: Array<{ __typename?: 'User', id: string, image?: string | null, name?: string | null, role: Role }> };

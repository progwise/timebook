...
export const Clock = () => {
  ...
  return (
    <>
      ...
      <svg
        viewBox="0 0 40 40"
        className="w-6 rotate-[-90deg] fill-base-100 stroke-base-content stroke-[1.5px]"
        style={
          {

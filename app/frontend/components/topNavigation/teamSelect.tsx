...
export const TeamSelect = () => {
  ...
  return (
    <Menu as="div" className="relative mx-3 my-3 py-1 px-4">
      <Menu.Button>{teamData ? <span className="w-9">{teamData.team.title} </span> : 'Your Teams'}</Menu.Button>
      <Menu.Items className="absolute right-0 flex w-full flex-col rounded-md bg-white p-4 shadow">
